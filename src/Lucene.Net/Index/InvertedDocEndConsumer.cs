// -----------------------------------------------------------------------
// <copyright company="Apache" file="InvertedDocEndConsumer.cs">
//
...
namespace Lucene.Net.Index
{
    ...
    {
        public abstract void Flush(IDictionary<FieldInfo, InvertedDocEndConsumerPerField> fieldsToFlush, SegmentWriteState state);
